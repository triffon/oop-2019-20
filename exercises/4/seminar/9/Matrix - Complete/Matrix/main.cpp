...
int main() {
   /*Rational data[] = {
    ...
    fo.seekp(2 * sizeof(int) + 4 * sizeof(Rational), ios::beg);
    Rational r(12,5);
    ...
    /*Rational r2;
    f.seekg(2 * sizeof(int) + 4 * sizeof(Rational), ios::beg);
    f.read((char*)&r2, sizeof(Rational));
    cout << r2;
    cout << endl;
    f.seekg((-2) * sizeof(Rational), ios::end);
    f.read((char*)&r2, sizeof(Rational));
    cout << r2;
    cout << endl;
    cout << f.tellg() << endl;*/
